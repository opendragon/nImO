...
#    echo "    adda       add an application"
    ...
    echo "    getps      list the mutable parameters of a node"
    echo "    getpv      report the value of a mutable parameter of a node"
...
#    echo "    remove     remove an application"
    echo "    setpv      set the value of a mutable parameter of a node"
